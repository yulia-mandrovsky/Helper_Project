    ...
    render() {
        return (
            <div className="wrapper" >
                <div className="arrow_registration_first">
                    <Link to="/">
                ...
                <label className="registration_first_label">
                    <input className="checkbox_performer"
                        ...
                        />
                     Want to be a helper<br/>
                </label>
                <input type='password' name="password" placeholder="Password *" className="registration_first_input input" onChange={this.handleUserInput}></input>
                <div className='panel panel-default'>
                <FormErrors formErrors={this.state.formErrors} />
                </div>
                <button className="sign_up_registration_first" disabled={!this.state.formValid} onClick={this.state.formValid ? this.clickHandler : null}>Sign Up</button>
